...
const FeatureComponent=()=> {
  const features = [
    {
      title: "Easily Track Recipes and Ingredients",
      description:
        "Manage your favorite recipes and keep track of ingredients effortlessly with our intuitive kitchen interface.",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Capture Dish Photos Easily",
      description:
        "Effortlessly capture beautiful photos of your dishes..",
    ...
    },
    {
      ...
      description:
        "Catch all the details about our product on YouTube—anytime, anywhere.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Instantly Share Recipe Content",
      description:
        "Easily upload and share your recipe photos and videos in seconds.",
      skeleton: <SkeletonFour />,
      className: "col-span-1 lg:col-span-3 border-b lg:border-none",
    },
  ];
  return (
    (<div className="relative z-20 py-10 lg:py-40 mx-auto bg-black h-full max-w-full">
      <div className="px-8">
        <h4
        ...
        <p
          ...
          From recipe discovery to meal prep assistance, our kitchen app has everything you need. It even helps you organize your cooking videos and photos!
        </p>
      </div>
...
export const SkeletonOne = () => {
  return (
    (<div className="relative flex py-8 px-2 gap-10 h-full w-full">
      <div
        ...
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          ...
          <Image
            ...
            width={800}
            height={500}
            className="h-96 w-full aspect-square object-fit object-left-top rounded-sm" />
        </div>
      </div>
      <div
